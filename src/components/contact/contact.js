...
const Contact = () => {
    ...
    const validateForm = () => {
        ...
        const errors = {
            ...
            email: !formData.get('your_email') || !/^\S+@\S+\.\S+$/.test(formData.get('your_email')),
        ...
        <section id='contactpage'>
            <div id='clients'>
                ...
                <p className='clientdesc'>
                    ...
                    You would be the first one to work with me. I hope you don't mind that. 
                    I'm eager to learn and improve my skills. I think we can create something great together😊
                </p>
            </div>
            ...
            <div id='contact'>
                ...
                <form className='contactform' ref={form} onSubmit={sendEmail}>
                    ...
                    <div className="form-group">
                        ...
                        />
                        {formErrors.message && <span className="error-message">Message is required</span>}
                    </div>
